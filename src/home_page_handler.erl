...
welcome(Req, State) ->
	...
	Popular_Videos_Url = "http://api.contentapi.ws/videos?channel=world_news&limit=6&skip=5&format=short",
	...
	More_Videos_Url = "http://api.contentapi.ws/videos?channel=world_news&limit=9&skip=23&format=short",
